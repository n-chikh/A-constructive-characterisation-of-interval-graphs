...
Each module in [main/src]([https://duckduckgo.com](https://github.com/n-chikh/A-constructive-characterisation-of-interval-graphs/tree/main/src)) folder corresponds to a specific a definition or result in the paper. Here is an outline:
1.  proposition1.py
2.  proposition3.py
